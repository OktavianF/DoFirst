...
class TaskHighlightPage extends StatelessWidget {
  const TaskHighlightPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const _TaskHighlightPageContent();
  }
}

class _TaskHighlightPageContent extends StatefulWidget {
  const _TaskHighlightPageContent();

  @override
  State<_TaskHighlightPageContent> createState() => _TaskHighlightPageContentState();
}

class _TaskHighlightPageContentState extends State<_TaskHighlightPageContent> {
